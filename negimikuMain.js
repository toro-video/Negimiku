...
function preload(){
	//img_load
	img_logo = loadImage("negimiku_logo_500.png");
	bg_leef = loadImage("25351.png");
	bg_lacquer = loadImage("18693.png");
	img_bg = loadImage("bg.png");
	img_miku = loadImage("hatyune.png");// https://prcm.jp/album/rintyannau/pic/15721204
	img_leek = loadImage("leek.png");
	img_get = loadImage("get_mid.png");
	img_finish = loadImage("finish.png");
	img_goldleek = loadImage("gold_leek.png");
	img_p_leek = loadImage("poisonus_leek.png");
	img_can = loadImage("speedUPCanRe.png");
	arrow = loadImage("arrow.png");
	pause_mark = loadImage("pause.png");
